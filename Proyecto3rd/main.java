...
public class Main {
     ...
     * @param encargados Lista de encargados a exportar.
     */
    public static void exportarEconomia(ArrayList<Economia> economia) {
        String archivoCSV = "Economia.csv";
        String archivoHTML = "Economia.html";

        try {
            FileWriter fwCSV = new FileWriter(archivoCSV, false);

            for (Economia eco : economia) {
                String cadena = eco.getMes() + "," + eco.getDesc() + "," +eco.getDinero()+","+eco.getEstado();
                fwCSV.write(cadena);
            }
            fwCSV.close();
            System.out.println("Datos de economia exportados correctamente a " + archivoCSV);

            FileWriter fwHTML = new FileWriter(archivoHTML, false);
            fwHTML.write("<!DOCTYPE html>\n<html>\n<head>\n<title>Encargados</title>\n</head>\n<body>\n");
            fwHTML.write("<h1>Lista de Economia</h1>\n");
            fwHTML.write("<table style=\"border: 1px solid black;\">\n");
            fwHTML.write("<tr style=\"border: 1px solid black;\"><th style=\"border: 1px solid black;\">Mes</th><th style=\"border: 1px solid black;\">Descripción</th><th style=\"border: 1px solid black;\">Dinero</th><th style=\"border: 1px solid black;\">Estado</th>\n");

            for (Economia eco : economia) {
                fwHTML.write("<tr style=\"border: 1px solid black;\">");
                fwHTML.write("<td style=\"border: 1px solid black;\">" + eco.getMes() + "</td>");
                fwHTML.write("<td style=\"border: 1px solid black;\">" + eco.getDesc() + "</td>");
                fwHTML.write("<td style=\"border: 1px solid black;\">" + eco.getDinero() + "</td>");
                fwHTML.write("<td style=\"border: 1px solid black;\">" + eco.getEstado() + "</td>");
                fwHTML.write("</tr>\n");
            }

            fwHTML.write("</table>\n</body>\n</html>");
            fwHTML.close();
            System.out.println("Datos de economia exportados correctamente a " + archivoHTML);
